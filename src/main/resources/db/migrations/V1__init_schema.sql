...
CREATE INDEX idx_problem_tags_name ON problem_tags(name);


-- ==============================
-- PROBLEM TAG MAP (MANY-TO-MANY)
-- ==============================
CREATE TABLE problem_tag_map (
...
CREATE INDEX idx_ptm_problem ON problem_tag_map(problem_id);
CREATE INDEX idx_ptm_tag ON problem_tag_map(tag_id);
...
CREATE INDEX idx_company_tags_name ON company_tags(name);
...
CREATE TABLE problem_company_map (
                                     ...
                                     CONSTRAINT fk_pcm_problem
                                         FOREIGN KEY (problem_id)
                                             REFERENCES problems(id)
                                             ON DELETE CASCADE,

                                     CONSTRAINT fk_pcm_company
                                         FOREIGN KEY (company_id)
                                             REFERENCES company_tags(id)
                                             ON DELETE CASCADE
);

CREATE INDEX idx_pcm_problem ON problem_company_map(problem_id);
CREATE INDEX idx_pcm_company ON problem_company_map(company_id);
